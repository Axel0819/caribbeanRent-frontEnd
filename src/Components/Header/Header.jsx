    ...
    return (
        <div className="mb-7 mt-8">
            <div className="flex justify-content-center align-items-center mb-7">
                <button type="submit" className="button-style button-action mr-8"
                    style={{ width: 350 }}><i class="fa-solid fa-house-chimney mr-3"></i>Buscar apartamento</button>

                <button type="submit" className="button-style button-action"
                    style={{ width: 350 }}><i class="fa-solid fa-user-group mr-3"></i>Buscar rommie</button>
            </div>
